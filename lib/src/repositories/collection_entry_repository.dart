...
abstract class CollectionEntryRepository {
  factory CollectionEntryRepository(Dio dio, {String baseUrl}) =
      _CollectionEntryRepository;
  ...
  Future<List<CollectionEntry>> list({
    ...
    @DateTimeConverter() @Query('fromDate') required DateTime fromDate,
    @DateTimeConverter() @Query('toDate') required DateTime toDate,
  });
