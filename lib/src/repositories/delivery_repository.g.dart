...
class _DeliveryRepository implements DeliveryRepository {
  _DeliveryRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<Delivery> write(Delivery delivery) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(delivery.toJson());
    final _options = _setStreamType<Delivery>(
    ...
    late Delivery _value;
    try {
      _value = Delivery.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<List<Delivery>> listByIds({required List<String> ids}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'ids': ids};
